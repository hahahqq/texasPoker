...
// getters
const getters = {
  setReconciliaRateState: state => state.setReconciliaRateState,
...
// actions
const actions = {
  setReconciliaRate({commit}, data){  //修改商家对账比例
    let userInfo = getUserInfo()
    let sendData = {
      InterfaceCode: '60101009_1',
      'CompanyId': userInfo.CompanyID,
      ReconciliaRate: data.ReconciliaRate
    }
    commonSend.commonSend('get',data => {
      commit(SET_RECONCILIA_RATE, { data })
    }, sendData )
  },
...
// mutations
const mutations = {
  [SET_RECONCILIA_RATE](state, {data}){
    state.setReconciliaRateState = data
  },
