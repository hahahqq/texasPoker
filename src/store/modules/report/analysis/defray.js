...
let selected={}
var ListARR = [
  { InterfaceCode:'6010307_01',title:'支出分析详情',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
]
...
// actions
const actions = {
  getdefrayReportData ({commit},data) {
    let userInfo= getUserInfo();
    let homeInfo = getHomeData();
    let sendData = {
      'InterfaceCode': '21002071203',
...
const mutations = {
  [GET_DEFRAYREPORT_DATA] (state, { data }) {
    if(data.success){
      ...
      //   console.log("state.defrayReportData")
      //   console.log(state.defrayReportData.List)
      //   console.log("state.defrayReportData")
      // }
    }
