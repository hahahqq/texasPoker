...
// actions
const actions = {
  saveSngGame({commit}, data){  // SNG增加比赛
  ...
  sngCancelOrGameOver({commit}, data){   // SNG取消比赛  0 : 取消比赛  1：比赛结束
      let userInfo = getUserInfo()
      let sendData = {
  ...
  sngExitGame({commit}, data){  // SNG退出比赛
      let userInfo = getUserInfo()
      let sendData = {
  ...
  editSngGame({commit}, data){ // 修改sng比赛
    let userInfo = getUserInfo()
  ...
  sngStartSignUp({commit}, data){  // sng 比赛报名
    let userInfo = getUserInfo();
    let sendData = {
  ...
  sngSubmitReward({commit}, data){  // SNG领取奖励
    console.log(data)
    let userInfo = getUserInfo();
    let sendData = {
  ...
  sngCancelRewardVip({commit}, data){   // SNG取消奖励(按会员)
    let userInfo = getUserInfo()
    let sendData = {
