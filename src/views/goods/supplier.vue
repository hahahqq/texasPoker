    ...
    <el-container>
      <div class="content-new-fex">
        ...
        <el-dialog :title='titleName' width="770px" :visible.sync='showAddSupplier' :close-on-click-modal='false' :before-close="handleDialogClose" append-to-body>
           <add-new-supplier @closeModal='showAddSupplier=false' @resetList='showAddSupplier=false;handleDialogClose()' :dealSupplier="{value:1,dealState: isAddSupplier ? 'add' : 'edit'}"></add-new-supplier>
        </el-dialog>
      </div>
    </el-container>
  </el-container>
