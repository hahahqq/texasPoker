  ...
  <el-container>
    ...
    <el-container>
      <div class="content-new-fex"> 
        ...
        <history-page v-on:isAddNewBill_A='isAddNewBill_A' v-if="current==1"></history-page>
      </div>
    </el-container>
  </el-container>
</el-container>
...
export default {
  ...
  data() {
    return {
      current: 0,
      businessList:[{id:'001',name:"采购调拨"},{id:'002',name:"采购调拨历史"}],
  ...
  methods: {
    ...
    clearSetItem(){
        this.$store.dispatch('cgdAllocationDataList', {
            arr: [], obj:{}
        })
    },
    handleClose(done) {
  ...
  components: {
    addPage: () => import("@/views/goods/allocation/addNew.vue"),
    historyPage: () => import('@/views/goods/allocation/history.vue')
  }
};
</script>
<style scoped>
