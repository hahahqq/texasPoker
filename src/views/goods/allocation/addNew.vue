        ...
        <el-row :gutter="10">
            <el-col :xs="24" :md="6" >
              ...
              <el-select size='small' clearable v-model="curOutShopId" placeholder="请选择调出店铺">
                <el-option v-for="item in shopList" :key="item.SHOPID" :disabled="item.SHOPID == curInShopId" :label="item.SHOPNAME" :value="item.SHOPID"></el-option>
              </el-select>
            </el-col>
            <el-col :xs="24" :md="6" >
              <span>调入店铺</span>
              <el-select size='small' clearable v-model="curInShopId" placeholder="请选择调入店铺">
                <el-option v-for="item in shopList" :key="item.SHOPID" :disabled="item.SHOPID == curOutShopId" :label="item.SHOPNAME" :value="item.SHOPID"></el-option>
              </el-select>
            </el-col>
            <el-col :xs="24" :md="6" >
              <el-input
      ...
      <div class="content-table-center">
        <div class='tableStyle'>
          ...
          >
            ...
            <el-table-column prop="PRICE" label="零售价" align="center" width="180"></el-table-column>
            <el-table-column label="数量" align="center" width="180">
              <template slot-scope='scope'>
                <span v-if='!scope.row.isEdit'>{{scope.row.QTY}}</span>
                <el-input-number v-if='scope.row.isEdit' size='small' style='width:160px' controls-position="right" :min="1" v-model.trim="scope.row.QTY" placeholder="请输入"></el-input-number>
              </template>
            </el-table-column>
        ...
        <div class='marginTB-sm'>
          ...
          <span class='text-right' style='float:right'>
            ...
            <el-button type='info' @click='handleSubmit(0)' :disabled="theGoodsList[0].GOODSNAME == ''" :loading="loading">草稿</el-button>
