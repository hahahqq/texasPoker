  ...
  <el-container>
    ...
    <el-container>
      <div class="content-new-fex"> 
        ...
        <history-page v-on:isAddNewBill_I='isAddNewBill_I' v-if="current==1"></history-page>
      </div>
    </el-container>
  </el-container>
</el-container>
...
export default {
  ...
  data() {
    return {
      current: 0,
      businessList:[{id:'001',name:"采购盘点"},{id:'002',name:"采购盘点历史"}],
  ...
  methods: {
    ...
    clearSetItem(){
        this.$store.dispatch('cgdInventoryDataList', {
            arr: [], obj:{}
        })
    },
    handleClose(done) {
  ...
  components: {
    addPage: () => import("@/views/goods/inventory/addNew.vue"),
    historyPage: () => import('@/views/goods/inventory/history.vue')
  }
};
</script>
<style scoped>
