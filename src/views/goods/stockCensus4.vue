    ...
    <div class="content-table-caiGouReport" :style="{ height: tableHeiht + 'px' }">
      <div class="content-table-center p-bottom-sm">
        ...
        >
          ...
          <el-table-column prop="STOCKQTY" label="盘点数量"></el-table-column>
          <el-table-column prop="QTY" label="盈亏数量"></el-table-column>
          <el-table-column prop="MONEY" label="盈亏金额"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    searchData() {
      this.ruleForm.ShopId = this.ShopId;
      this.ruleForm.TypeId = this.TypeId;
