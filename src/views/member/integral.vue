<template>
  <el-container>
    ...
    <el-container>
      ...
      <el-container>
        <div class="content-new-fex" style="padding: 0; background: #f8f8f8">
          <el-row>
            <el-col :span="8">
              <div>
                <dropdown
              ...
              <div class="integrgl" :style="{ height: height + 'px' }">
                <el-form label-width="110px" class="fastc_top">
                  <el-row class="fastc_top_cont">
                    ...
                    <el-form-item label="调整后储值积分" style="">
                      <el-input
                  ...
                  <div
                    style="width: 100%; height: 10px; float: left; background: #f4f5fa"
                    v-if="splitIntegral"
                  ></div>
                  ...
                  <el-row class="fastc_top_cont" v-if="splitIntegral">
                    ...
                    <el-form-item label="调整后竞技积分">
                      <el-input
                        v-model.trim="changeAfterIntegral"
                        style="width: 85%"
                        size="medium"
                        autocomplete="off"
                        class="full-width"
              ...
              >
                <span style="display: table-cell; padding-top: 200px">
                  <img
                    ...
                    alt=""
                  />
                  <div style="color: #868686; margin-top: 20px">一步到位，矫正积分值</div>
                </span>
              </div>
            </el-col>
          </el-row>
