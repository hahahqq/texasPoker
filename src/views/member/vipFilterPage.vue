      ...
      <el-row>
         <el-col :span="16">
            <el-row>
               <el-col :span="10">
                  <el-button-group>
                     <el-button plain v-for="(label,i) in ['今天','昨天','本月','上月','其它']" :key="i" @click="chooseDate(i)" type="primary" size="small" :class="{'isActive':chooseDateIdx==i}">{{label}}</el-button>
                  </el-button-group>
               </el-col>
               <el-col :span="14">
                     <div>
                        <el-date-picker v-if='!isHideOther'
                           ref="dateBE"
                           size="small"
                           v-model="dateBE"
                        ...
                        <el-date-picker v-if="isHideOther && chooseDateIdx==4"
                           v-model="dataEndTime"
                           type="date"
                           size="small"
                           @change="chooseDate3"
...
export default {
    ...
    methods: {
        ...
        chooseDate3(){
           this.ruleFrom.EndDate = this.dataEndTime
