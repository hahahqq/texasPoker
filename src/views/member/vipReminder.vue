...
<el-container>
  ...
  <el-container>
    ...
    <el-container :style="`height:${windowHeight}px; overflow:auto`">
       <signUpReminder v-if="current == 0"></signUpReminder>
       <birthdayReminder v-if="current == 1"></birthdayReminder>
       <overdueReminder v-if="current == 2"></overdueReminder>
       <newVipReminder v-if="current == 3"></newVipReminder>
    </el-container>
  </el-container>
</el-container>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            current: 0,
            businessList:[{id:'001',name:"报名提醒",number: ""},{id:'002',name:"生日提醒",number: ""},{id:'003',name:"过期提醒",number:""},{id:'004',name:"新增会员提醒",number:""}],
    ...
    components: {
        signUpReminder: () => import("@/views/member/signUpReminder.vue"),
        birthdayReminder: () => import("@/views/member/birthdayReminder.vue"),
        overdueReminder: () => import("@/views/member/overdueReminder.vue"),
        newVipReminder: () => import("@/views/member/newVipReminder.vue"),
    }
};
</script>
<style scoped>
