   ...
   <div class="bg-white paddingTB-md" v-loading="loading">
      ...
      >
         ...
         <el-table-column label="充值" align="center">
            ...
            <el-table-column prop="ADDMONEYBILLCOUNT" label="笔数" align="right"></el-table-column>
         </el-table-column>
         <el-table-column label="销售" align="center">
            ...
            <el-table-column prop="INTEGRALMONEY" label="积分支付" align="right"></el-table-column>
            <el-table-column
               prop="SALEPAYMONEY"
               label="销售实收"
               width="90px"
         ...
         <el-table-column label="赛事" align="center">
            <el-table-column prop="MATCHBUYMONEY" label="买入积分" align="right"></el-table-column>
            <el-table-column
