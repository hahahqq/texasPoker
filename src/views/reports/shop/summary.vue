	...
	<div class="bg-white paddingTB-md" v-loading="loading">
		...
		>
			<el-table-column>
				...
				<el-table-column prop="SHOPSALEMONEY" label="营业实收"></el-table-column>
				<el-table-column prop="SHOPGAINMONEY" label="盈利"></el-table-column>
			</el-table-column>
			<el-table-column label="充值">
				<el-table-column prop="ADDMONEY" label="金额"></el-table-column>
				<el-table-column prop="ADDMONEYBILLCOUNT" label="笔数"></el-table-column>
			</el-table-column>
			<el-table-column label="销售">
				<el-table-column prop="SALEMONEY" label="金额"></el-table-column>
				<el-table-column prop="SALEBILLCOUNT" label="笔数"></el-table-column>
				<el-table-column prop="INTEGRALMONEY" label="积分支付"></el-table-column>
				<el-table-column prop="SALEPAYMONEY" label="销售实收"></el-table-column>
				<el-table-column prop="SALEGAINMONEY" label="盈利"></el-table-column>
			</el-table-column>
			<el-table-column label="赛事">
				<el-table-column prop="MATCHBUYMONEY" label="买入积分"></el-table-column>
				<el-table-column prop="MATCHCHARGESMONEY" label="服务费"></el-table-column>
				<el-table-column
				...
				<el-table-column
					...
					width="100px"
				></el-table-column>
				<el-table-column prop="MATCHGAINMONEY" label="盈利"></el-table-column>
			</el-table-column>
...
export default {
	...
	methods: {
		getNewData() {
			this.loading = true;
			indexQuery.shop(this, "sum", this.formData);
		},
