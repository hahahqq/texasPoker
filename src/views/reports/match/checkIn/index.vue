			...
			<div class="bg-white m-bottom-sm- paddingTB-md">
				<div class="marginLR-md">
					...
					>
						...
						<el-table-column prop="BUYPRICE" label="单手金额"></el-table-column>
						...
						<el-table-column prop="CHARGESMONEY" label="预付金额"></el-table-column>
						<el-table-column prop="PAYINTEGRAL" label="竞技积分扣减"></el-table-column>
