<template>
	<div class="reportFilte">
		<div class="row-flex flex-between align-self-center">
			<div class="" style="min-width: 670px">
				<!-- date -->
				<div class="dateDiv inline-block" v-if="!isNoDate">
					<el-button-group>
						<el-button
							plain
					...
					<div class="inline-block dateDiv">
						<el-date-picker
							:disabled="chooseDateIdx != 4"
							v-model="ruleFrom.BeginDate"
...
.dateDiv >>> .el-input--small .el-input__inner {
	height: 33px;
	line-height: 33px;
