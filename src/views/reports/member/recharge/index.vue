            ...
            <div class="marginLR-md">
               ...
               >
                  <el-table-column
                     ...
                     fixed="left"
                  ></el-table-column>
                  <el-table-column prop="DATESTR" label="日期" width="140px"></el-table-column>
                  <el-table-column
                     prop="SHOPNAME"
                     label="店铺"
                     width="175px"
                  ...
                  <el-table-column prop="ADDMONEY" label="充值金额" align="right"></el-table-column>
                  <el-table-column prop="ADDMONEY" label="增加积分" align="right"></el-table-column>
                  <el-table-column
                     prop="GIFTMONEY"
                     label="赠送积分"
                     align="right"
