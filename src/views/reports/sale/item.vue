<template>
   <div v-loading="loading">
      ...
      <div>
         ...
         <div class="m-bottom-sm">
            <el-button-group>
               <el-button type="primary" size="small" :plain="oType" @click="chooseStateFun(1)">
                  按金额
               </el-button>
               <el-button type="primary" size="small" :plain="!oType" @click="chooseStateFun(2)">
                  按数量
               </el-button>
            </el-button-group>
         </div>
...
export default {
   ...
   computed: {
      dataListState() {
         return this.$store.getters.cReportDataState.saleItem;
      }
   },
   watch: {
      typeData(data) {
