          ...
          <div class="content-table-center" style="padding-top: 0">
            ...
            <div class="print row-flex flex-start m-top-sm">
              <section class="printEG">
                <div class="top">
                  <div
                    ...
                    v-if="printList.title.isShow"
                  >
                    {{ printList.title.value }}
                  </div>
                  <div class="text-center paddingTB-xs">{{ shopName }}_领奖小票</div>
                ...
                <div class="center">
                  <ul>
                    <li class="row-flex">
                      <span style="width: 25%">奖品</span>
                      <span style="width: 25%; text-align: center">积分</span>
                      <span style="width: 25%; text-align: center">数量</span>
                      <span style="width: 25%; text-align: center">小计</span>
                    </li>
                  ...
                  <div
                    class="line"
                    v-if="
                      printList.vipInfo[0].isShow ||
                      printList.vipInfo[1].isShow ||
                      printList.vipInfo[2].isShow
                    "
                  >
                    <i></i>
                  </div>
                  ...
                  <div class="text-center m-top-md">
                    <div class="marginTB-xxs overflow-hidden" v-if="printList.footNote.isShow">
                      {{ printList.footNote.value }}
                    </div>
                    <img
                      :src="printList.shopQRCode.value"
                      style="width: 100px"
                      v-if="printList.shopQRCode.isShow"
                    />
                  </div>
                </div>
              ...
              <div
                ...
                "
                class="m-top-md padding-md m-left-md"
              >
                <div style="margin-bottom: 12px">
                  <span>自动打印小票</span>
                  <el-switch
                    v-model="printList.autoPrint"
                ...
                <div class="row-flex flex-between flex-items-center" style="margin-bottom: 12px">
                  ...
                  <el-select
                    size="mini"
                    v-model="printList.setupPrintnum"
                    placeholder="请选择"
                ...
                <div class="row-flex">
                  <el-checkbox
                    v-model="printList.title.isShow"
                    class="marginTB-xs"
                    style="width: 100px"
                  >
                    {{ printList.title.label }}
                  </el-checkbox>
                  <a
                    class="m-top-xs inline-block border-bottom full-width pointer"
                    @click="changeLabel(printList.title)"
                  >
                    {{ printList.title.value }}
                  </a>
                </div>
                ...
                <div class="row-flex">
                  <el-checkbox
                    v-model="printList.footNote.isShow"
                    class="marginTB-xs"
                    style="width: 100px"
                  >
                    {{ printList.footNote.label }}
                  </el-checkbox>
                  <a
                    class="m-top-xs inline-block border-bottom full-width pointer"
                    @click="changeLabel(printList.footNote)"
                  >
                    {{ printList.footNote.value }}
                  </a>
                </div>
                ...
                <div class="shopInfoItem" style="display: table">
                  <el-checkbox v-model="printList.phone.isShow">
                    {{ printList.phone.label }}
                  </el-checkbox>
                  <el-checkbox v-model="printList.address.isShow">
                    {{ printList.address.label }}
                  </el-checkbox>
                  <el-checkbox v-model="printList.shopQRCode.isShow">
                    {{ printList.shopQRCode.label }}
                  </el-checkbox>
                  <el-checkbox v-model="printList.remark.isShow">
                    {{ printList.remark.label }}
                  </el-checkbox>
                  <el-checkbox v-model="printList.saleEmploy.isShow">
                    {{ printList.saleEmploy.label }}
                  </el-checkbox>
                </div>

                <!-- 会员信息 -->
                <div style="display: table; font-size: 14px; margin-top: 10px; font-weight: bold">
                  会员信息
                </div>
...
export default {
  ...
  methods: {
    ...
    savePrintRules() {
      localStorage.setItem(SYSTEM_INFO.PREFIX + "Print5", JSON.stringify(this.printList));
