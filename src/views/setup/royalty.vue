          ...
          <div v-for="(item,i ) in tableList1" :key="i" class="marginTB-sm">
            ...
            <div class="inline-block border rounded-xs border-color">
              ...
              <span
                ...
                class="inline-block bg-theme text-white paddingTB-xs text-center"
...
export default {
  ...
  watch: {
    ...
    RState(data) {
      ...
      if (!data.success) {
        ...
        this.$store.dispatch("getRechargeValue").then(() => { console.log(1111)
          this.loading1 = true;
        });
      }
    },
  ...
  mounted() {
    ...
    this.$store.dispatch("getFastConsumeValue")
  },
  components: {
