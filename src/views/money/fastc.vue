                                    ...
                                    <el-form label-width="80px" class="fastc_top">
                                        <el-row style="padding-top:10px;">
                                            ...
                                            <el-form-item label="支付方式" style='margin-bottom: 10px; padding-top: 10px; border-top: 1px dashed #ddd'>
                                              ...
                                              <el-radio v-if="splitIntegral == true" v-model="payType" label="1">竞技积分</el-radio>
                                            </el-form-item>
                                        </el-row>
                                    </el-form>
...
export default {
    ...
    methods: {
       testPrint(billId, jsonPrintData){
         ...
         vipInfo[2].value = this.payType == '0' ? this.memberInfo.MONEY - Number(this.form.money) : this.memberInfo.MONEY ;
         if (this.splitIntegral) {
            vipInfo.push({
               label: "竞技积分",
               value: this.payType == '1' ? this.memberInfo.INTEGRAL - Number(this.form.money) : this.memberInfo.INTEGRAL,
        ...
        CashPayok(){
           let sendData = {
            ...
            this.$store.dispatch('fastPayMoney', sendData ).then(() =>{
               this.$store.dispatch("selectingMember", {});
            })
        }
    },
