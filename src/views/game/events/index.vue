                ...
                <el-col :span="8">
                  <el-dropdown size="small" class="pull-left" @command="checkProjectTypeFun">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <el-dropdown-item command="3" v-if="IsIntegralMatch">
                        自由积分赛
                      </el-dropdown-item>
                    </el-dropdown-menu>
                  </el-dropdown>
              ...
              >
                ...
                <el-table-column prop="NAME" label="比赛项目">
                  <template slot-scope="scope">
                    <el-button type="text" @click="handleViewItem(scope.row, scope.$index)">
                      {{ scope.row.NAME }}
                    </el-button>
                  </template>
                </el-table-column>
                ...
                <el-table-column label="服务费" align="center">
                  <template slot-scope="scope">
                    {{
                      scope.row.CHARGESTYPE == 0
                        ? Number(scope.row.CHARGESRATE) * 100 + "%"
                        : scope.row.CHARGESMONEY + "元"
                    }}
                  </template>
                </el-table-column>
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    ...
                    <el-button size="small" type="text" @click="handleDel(scope.row, scope.$index)">
                      删除
                    </el-button>
                  </template>
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getNewData(Type, PN) {
      this.$store
        .dispatch("getEventsList", { Type: Type, PN: PN, IsIntegralMatch: this.IsIntegralMatch })
        .then(() => {
          this.loading = true;
        });
    },
