    ...
    >
      <el-row style="margin-top: 8px">
                ...
                <el-row>
                  ...
                  <el-col :span="6">
                    ...
                    <p class="systemRemind2">
                      {{ headerDateRegVipInfo.SUMREGQTY1 ? headerDateRegVipInfo.SUMREGQTY1 : "--" }}
                    </p>
                    <p>
                      昨日：
                      <i class="systemRemind3">
                        {{
                          headerDateRegVipInfo.SUMREGQTY2 ? headerDateRegVipInfo.SUMREGQTY2 : "--"
                        }}
                      </i>
                    </p>
                  </el-col>
        ...
        <el-col :span="5" class="pull-right">
          ...
          >
            <div style="padding-top: 20px; margin-left: 15px; font-size: 13px; font-weight: bold">
              <span>您的店铺即将到期</span>
            </div>
            ...
            <div style="position: absolute; bottom: 20px; width: 100%">
              <el-popover placement="bottom" width="350" v-model="visibleMsagess" trigger="click">
                <div>
                  <div class="renew-top">
                    <div>
                      <img src="static/images/renew.png" style="width: 50px; height: 40px" />
                    </div>
                    <div>
                      <p>
                        您好！您登陆的
          ...
          <div v-else class="bgwhitecolor home-border-r" style="padding: 0; height: 170px">
            ...
            >
              <el-popover placement="left" width="200" trigger="click">
                ...
                <div style="margin: 0 auto; width: 100%; text-align: center; border-radius: 10px">
                  <img id="codeImgID" :src="item.codeImg" width="120px" height="120px" />
                </div>
              </el-popover>
            </div>
            <div
