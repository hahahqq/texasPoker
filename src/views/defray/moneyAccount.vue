      ...
      <el-container>
        <div class="content-new-fex">
              ...
              >
                ...
                <el-table-column label="操作" align="right">
                  <template slot-scope="scope">
                    ...
                    <el-button size="small" type="text" @click="handleItem(scope.row)">
                      详情
                    </el-button>
          ...
          >
            ...
            <div v-if="pagination.TotalNumber > 20" class="m-top-smts clearfix elpagination">
              <el-pagination
          ...
          >
            <el-form ref="ruleForm3" :model="ruleForm3" :rules="rules2" label-width="80px">
              ...
              <el-form-item>
                <el-button type="primary" @click="addAccount" :loading="formLoading">
                  保 存
                </el-button>
    ...
    dataListState1(data) {
      if (this.loading1) {
        if (data.success) {
          ...
          this.count = {
            BillCount: data.data.BillCount ? parseInt(data.data.BillCount) : 0,
  ...
  methods: {
    ...
    addAccount() {
      this.$refs.ruleForm3.validate((valid) => {
        if (valid) {
          this.$store.dispatch("setFirstAccountMoney", this.ruleForm3).then(() => {
            this.formLoading = true;
          });
        }
      });
