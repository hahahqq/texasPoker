                ...
                <div class="content-new-fex">
                   ...
                   <div class="content-table4">
                        <div class="content-table-center">
                            ...
                            <div v-show="pagination.TotalNumber > 0" class="m-top-smts clearfix elpagination">
                                <el-pagination
                        ...
                        <el-dialog :title='titleName' :visible.sync="showDialog" append-to-body width="50%" :before-close="cancelDialog">
                            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px">
                                ...
                                <el-form-item label='是否启用'>
                                    <el-switch v-model="ruleForm.IsStart" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                                </el-form-item>
