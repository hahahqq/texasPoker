                        ...
                        <el-row>
                            ...
                            <el-col :span="12">
                                <div class="imgUrl" :style="`color: ${ruleForm.Color}`">
                                    ...
                                    >
                                        <div style="padding: 10px 20px; height: 44px; float:left">
                                            ...
                                            <span style="float:left; width: 200px ; ">
                                                ...
                                                >{{ruleForm.Name == '' ? '会员名称' : ruleForm.Name}}</span>
...
export default {
    ...
    data() {
        return {
            logoImg: "static/images/"+ROOT_STATE+"/logo2.png",
            success: false,
            ruleForm: {
                Name: "",
                LevelId: "",
    ...
    methods: {
        curLevel(event, item) {
            let levelName = this.memberLevelList.filter(
                item => item.ID == this.ruleForm.LevelId
            );
