<template>
	<el-container>
		...
		<el-container>
			...
			<el-container>
				<el-main style="padding: 10px 10px 0; margin: 10px; background: #fff">
					<el-form
						ref="ruleForm"
						:model="ruleForm"
						label-width="80px"
					...
					>
									...
									<span
										v-text="
											Object.keys(selmemberArr).length > 0
												? '已选' + Object.keys(selmemberArr).length + '人'
												: '请选择'
										"
									></span>
								</el-button>
						...
						<el-form-item label="优惠卷">
							<div @click="showCouponClick" style="color: #3ea9ff; cursor: pointer">
								选择优惠卷
							</div>
						</el-form-item>
										...
										<div class="coupont-list">
											<div class="coupont-list-top">
												...
												>
													...
													<span
														style="padding-left: 4px; font-size: 12px"
													>
											...
											<div class="coupont-list-bottom text-overflow">
												【 {{item.COUPONTYPE}} 】  {{item.REMARK }}
											</div>
										</div>
									</li>
								</ul>
						...
						<el-form-item>
							<div class="full-width">
								<el-button
									type="primary"
									:disabled="ruleForm.CouponList.length == 0"
									@click="onSubmit"
								>
									保 存
								</el-button>
					...
					>
								...
								<ul>
									<li v-for="(item, index) in CouponList" :key="index">
										<div
											...
											:class="
												item.isSelect == true && activeName == 'first'
													? 'select-border'
													: ''
											"
										>
						...
						<div
							class="full-width"
							style="margin-top: 30px; display: table; text-align: center"
						>
							<el-button
								type="primary"
								@click="
...
export default {
	...
	watch: {
		...
		couponListState(data) {
            ...
            item.COUPONTYPE = item.TYPE == 0 ? '商品券' : '赛事券'
	...
	methods: {
		...
		handlePageChange: function (currentPage) {
			this.$store.dispatch("getMarketingShopList2", {
				...
				IsValid: this.activeName == "first" ? 0 : 1
			});
		},
