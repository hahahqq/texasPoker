					...
					<div style="overflow: auto; height: 100%; width: 100%">
						...
						<div style="max-width: 500px" class="m-rop-sm">
							<div class="padding-sm bg-grey rounded-xs">
								<div
									:class="isAll ? 'block' : 'inline-block'"
									style="padding: 6px 0"
								>
									<span>是否全选</span>
									<el-switch v-model="isAll"></el-switch>
									<span v-if="isAll" class="pull-right">
										总人数：{{ VipCount }}
									</span>
								</div>
								<el-button
								...
								<div class="text-right">
									<div class="pull-left" style="line-height: 32px">
										<span>剩余短信：</span>
										<span style="color: red">{{ SMSNumber }}条</span>
									</div>

									<el-button @click="onSubmit" size="small" :loading="loading">
										发 送
									</el-button>
								</div>
							</div>
							...
							<div>
								<p class="m-top-sm">
									...
									<span style="color: #f00">
										{{ SmsRemark.length + fixFontLength }}
									</span>
									个字（含退订回T、会员名和【短信签名】），还剩
									<span>{{ syfont }}</span>
									字，最多
									<span style="color: #f00">200</span>
									个字，当前内容按
								...
								<div class="marginTB-md">
									...
									<ul>
										...
										<li class="marginTB-sm">
											4、根据工信部《通信短信息服务管理规定》要求，所有营销短息需在结尾加退订回T，生意通已在短信内预置，无需重复添加；
										</li>

										<li class="marginTB-sm">
											5、请规范短信内容，随意内容可能会被短信平台过滤。
										</li>
									</ul>
								</div>
							</div>
