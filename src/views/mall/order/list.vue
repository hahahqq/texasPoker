<template>
    <section class="mallOrder bg-white p-bottom-sm" v-loading="loading">
                                ...
                                <table class="full-width" style="border-spacing: 0px;">
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    v-if="!itemList.RECEIPTNAME||itemList.RECEIPTNAME=='undefined'"
                                                >--</div>
                                                <div v-else>
                                                    <div>
        ...
        <el-dialog
            ...
            style="max-width:100%"
        >
            <itemPage @closeModal="showItem=false" @resetModal="showItem=false;getNewData();"></itemPage>
        </el-dialog>

        <!-- 发货 -->
        <el-dialog title="订单发货" :visible.sync="showDeliverGoods" width="600px">
            <deliverGoods-page
                :pageState="{'isShow':showDeliverGoods}"
                @closeModal="showDeliverGoods=false"
                @resetModal="showDeliverGoods=false;getNewData();"
            ></deliverGoods-page>
        </el-dialog>
        <!-- 修改价格 -->
        <el-dialog title="修改价格" :visible.sync="changeMoneyForm.isShow" width="600px">
            <changePricePage
                :pageData="changeMoneyForm"
                @closeModal="changeMoneyForm.isShow=false"
                @resetModal="changeMoneyForm.isShow=false;getNewData();"
            ></changePricePage>
        </el-dialog>
    </section>
</template>
