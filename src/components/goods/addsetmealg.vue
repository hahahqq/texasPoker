    ...
    <div class="goodsAdd" v-loading="loading">
        ...
        >
            ...
            <el-form-item label="套餐商品">
                ...
                <span class="pull-right">共{{total}}项项目套餐，合计￥{{TotalPrice}}</span>
            </el-form-item>
            <el-form-item>
                <el-table
                    border
                ...
                >
                        ...
                        <template slot-scope="scope">
                            <div class="sumchange">
                                <i
                                    ...
                                    @click="addjiajianhao(1,scope.row.GoodsId)"
                                ></i>
                                <span
                                    class="getqty"
                                    @click="changeQty(scope.row.GoodsId)"
                                >{{scope.row.Qty}}</span>
                                <i
                                    class="el-icon-circle-plus jiajianbtn"
                                    @click="addjiajianhao(2,scope.row.GoodsId)"
                                ></i>
                            </div>
                        </template>
                    </el-table-column>
                    <el-table-column label="操作" width="170" fixed="right">
                        <template slot-scope="scope">
                            <el-button
                                size="small"
                                @click="addjiajianhao(1,scope.row.GoodsId,'alldel')"
                            >删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
...
export default {
    ...
    watch: {
        ...
        goodsstemaealgdetailsState(data) {
            if (data.success) {
                ...
                this.ruleForm.Stockqty = obj.STOCKQTY;
    ...
    methods: {
        ...
        jisuantotal() {
            let GoodsList = this.ruleForm.GoodsList;
            this.ruleForm.GoodsList = [...this.ruleForm.GoodsList];
