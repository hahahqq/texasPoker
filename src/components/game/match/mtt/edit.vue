            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="24">
                    <el-form-item label="赛事名称" prop='Name'>
                        <el-input placeholder="请输入MTT赛事名称" v-model.trim='ruleForm.Name' clearable size="small"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                    <el-form-item label="比赛项目" prop="EventId">
                        <el-select size="small" v-model='ruleForm.EventId' @change='selectEventFun(ruleForm.EventId)' placeholder="请选择比赛项目" style='width:100%'>
                            <el-option v-for="item in eventsList" :key="item.ID" :value="item.ID" :label="item.NAME"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="12">
                    <el-form-item label="开赛时间" prop="PlayTime">
                        <el-date-picker v-model="ruleForm.PlayTime" size='small' type="datetime" format='yyyy-MM-dd HH:mm' placeholder="选择日期时间" style='width:100%'></el-date-picker>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                    <el-form-item label="比赛桌号" prop="DeskId">
                        <el-select size="small" v-model='ruleForm.DeskId' placeholder="请选择比赛桌号" style='width:100%'>
                            <el-option v-for="(item,index) in tableList" :key="index" :value="item.ID" :label="item.NAME"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="12">
                    <el-form-item label="启动线上报名">
                        <el-switch v-model="ruleForm.IsOnLine" active-color="#409eff" inactive-color="#ccc"></el-switch>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                    <el-form-item label="Buyin积分" prop="BuyinMoney">
                        <el-input placeholder="请输入参赛报名积分" :disabled='dataType.buyVipNum != 0' size="small" v-model.trim="ruleForm.BuyinMoney">
                ...
                <el-col :xs="24" :sm="12">
                    <el-form-item label="记分牌">
                        <el-input placeholder="请输入Buyin记分牌" :disabled='dataType.buyVipNum != 0' size="small" v-model="ruleForm.ChipsQty"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                    <el-form-item label="Rebuy积分">
                        <el-input placeholder="请输入重复买入积分" size="small" :disabled='dataType.buyVipNum != 0' oninput="value=value.replace(/\D/g,'')" v-model="ruleForm.RebuyMoney">
                            <template slot="append">积分</template>
                        </el-input>
                    </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="12">
                    <el-form-item label="记分牌">
                        <el-input placeholder="请输入Rebuy记分牌" size="small" :disabled='dataType.buyVipNum != 0' oninput="value=value.replace(/\D/g,'')" v-model="ruleForm.ChipsQty2"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                    <el-form-item label="Addon积分">
                        <el-input placeholder="请输入最后买入积分" size="small" :disabled='dataType.buyVipNum != 0' oninput="value=value.replace(/\D/g,'')" v-model="ruleForm.AddonMoney">
                            <template slot="append">积分</template>
                        </el-input>
                    </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="12">
                    <el-form-item label="记分牌">
                        <el-input placeholder="请输入Addon记分牌" size="small" :disabled='dataType.buyVipNum != 0' oninput="value=value.replace(/\D/g,'')" v-model="ruleForm.ChipsQty3"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                    <el-form-item label="服务费方式">
                        <el-select size="small" v-model='ruleForm.ChargesType' :disabled='dataType.buyVipNum != 0' placeholder="请选择服务费方式" style='width:100%'>
                ...
                <el-col :xs="24" :sm="12">
                    <el-form-item label="服务费比例" v-if='ruleForm.ChargesType == 0'>
                        <el-input placeholder="请输入服务费比例" size="small" :disabled='dataType.buyVipNum != 0' v-model="ruleForm.ChargesRate">
                            <template slot="append"> % </template>
                        </el-input>
                    </el-form-item>

                    <el-form-item label="服务费金额" v-if='ruleForm.ChargesType == 1'>
                        <el-input placeholder="请输入服务费金额" size="small" :disabled='dataType.buyVipNum != 0' v-model="ruleForm.ChargesMoney">
...
export default {
    ...
    computed: {
        ...mapGetters({
            mttEditGameState: 'mttEditGameState',
    ...
    watch: {
        ...
        getEventsDetailsState(data){
            ...
            if(data.success){
                ...
                this.ruleForm.RebuyMoney = obj.REBUYPRICE
                this.ruleForm.AddonMoney = obj.ADDONPRICE
                ...
                let param = data.data.RewardObj, newParam = []
    ...
    methods:{
        defaultItem(){
            ...
            let param = this.dataType.RewardList, newParam = []
            for(var i = 0; i< param.length ; i++){
                newParam.push({
                    Id: param[i].ID,
                    Name: param[i].NAME,
        ...
        submitBtn(){
            this.$refs.ruleForm.validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch("editMttGame", sendData).then(() =>{
