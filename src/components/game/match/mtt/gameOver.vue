    ...
    methods:{
      ...
      gameoverFun(){
        this.$confirm("确认结束当前比赛?", "提示", {
            ...
            this.$store.dispatch('mttCancelOrGameOver', { Type: 1, BillId: this.BillObj.BILLID }).then(() =>{
