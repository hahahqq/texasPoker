      ...
      <el-container>
        ...
        >
          ...
          >
            ...
            <el-row :gutter="10" style="margin-top: 10px" v-if="splitIntegral">
              <el-col :xs="24" :sm="11">
                <el-form-item label="消费竞技积分">
                  <el-input
                    ...
                    disabled
                    :class="formIntegral.integral_1 != 0 ? 'redColor' : 'grayColor'"
                    size="small"
                    style="width: 100%"
                  ></el-input>
                </el-form-item>
            ...
            <div v-show="tabs == 2">
              ...
              >
                ...
                <el-table-column prop="REWARDRATE" label="比例" width="100" align="center">
                  <template slot-scope="scope">
                    {{ (scope.row.REWARDRATE * 100).toFixed(2) }} %
                  </template>
                </el-table-column>
                <el-table-column
                  prop="CONTESTQY"
...
export default {
  ...
  watch: {
    ...
    getssmemberdListState(data) {
      ...
      if (data.success) {
        ...
        this.isEmptyData = _data.length != 0 ? false : true;
  ...
  methods: {
    ...
    searchTextFun(item) {
      ...
      this.integralGroupFun(item, this.BillObj.BUYINNEEDPRICE);
    },
    testPrint() {
    ...
    modifyCouponMoney(couponIntegral) {
      ...
      if (Number(couponIntegral) > Number(this.BillObj.BUYINNEEDPRICE)) {
        this.$message.warning("优惠积分不能大于报名积分");
        this.couponIntegral = this.BillObj.BUYINNEEDPRICE;
      }

      this.integralGroupFun(this.memberdetails, this.BillObj.BUYINNEEDPRICE - this.couponIntegral);
    },
