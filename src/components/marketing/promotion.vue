<template>
  ...
  <div>
    <el-table border 
      ...
      <el-table-column prop="CAPTION" label="名称" width="160">
      </el-table-column>
      ...
      <el-table-column label="操作" width="170" fixed="right" align="right">
        <template slot-scope="scope">
          <el-button type="text" size="small" :disabled="scope.row.ISSTOP" @click="handleStop(scope.$index, scope.row)">停止</el-button>
