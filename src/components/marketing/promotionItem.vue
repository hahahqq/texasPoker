            ...
            <el-col :span="12">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
                    ...
                    <el-form-item label="文字颜色">
                        <el-button
                            size="medium"
                            @click="setCurBg('#FFFFFF', 1)"
                            style="background:#FFFFFF; border:1px solid #999"
                        ></el-button>
                        <el-button
                            size="medium"
                            @click="setCurBg('#6bac94', 2)"
                            style="background:#6bac94"
                            border
                        ></el-button>
                        <el-button
                            size="medium"
                            @click="setCurBg('#29b1c9', 3)"
                            style="background:#29b1c9"
                            border
                        ></el-button>
                        <el-button
                            size="medium"
                            @click="setCurBg('#ee798c', 4)"
                            style="background:#ee798c"
                            border
                        ></el-button>
                        <el-button
                            size="medium"
                            @click="setCurBg('#f3b700', 5)"
                            style="background:#f3b700"
                            border
                        ></el-button>
                        <el-button
                            size="medium"
                            @click="setCurBg('#7db3e0', 6)"
                            style="background:#7db3e0"
                            border
                        ></el-button>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-col :span="12">
                ...
                <div class="imgUrl" :style="`color:${ruleForm.TextColor}`">
                    ...
                    >
                        ...
                        <span
                            class="full-width p-top-lg pull-left text-left"
                            style="padding-left:8px"
                        >
                            <span
                                style="font-size:5px"
                            >活动时间: {{ new Date(dateBE[0]) | time1}} 至 {{new Date(dateBE[1]) | time1}}</span>
                        </span>
                        <span
                            class="full-width p-top-sm pull-left text-left"
                            style="padding-left:8px"
                        >
                        ...
                        <ul>
                            ...
                            >
                                <el-button
                                    ...
                                    @click="deleteImgUrl(index,items.ID)"
                                    class="el-icon-delete"
                                ></el-button>
                                <img
                                    :src="items.IMAGE"
                                    alt
                                    @click="slectImgUrl(items)"
                                    width="45px"
                                    height="90px"
                                />
                            </li>
...
export default {
            ...
            if (data.success) {
                if (this.choseImg.isNewAdd != undefined) {
                    ...
                    let sendData = {
                        ...
                        SmallImage:
                            IMG_URL + IMG_FILEPATH[2] + "s" + name + ".png",
    ...
    methods: {
        ...
        addBgImg(data) {
            ...
            this.haveNewAddImg = this.marketingListImg.filter(
                item => item.ISSYS == 0
            );
        },
        ...
        defaultData() {
            ...
            if (this.dealType.type == "add") {
                ...
                this.ruleForm.EndDate = new Date(
                    this.getCustomDay(7)
                ).getTime();
            ...
            if (this.dealType.type == "edit") {
                ...
                if (this.dataItem.BEGINDATE != 1) {
                    this.dateBE = [
                        this.dataItem.BEGINDATE,
                        this.dataItem.ENDDATE
                    ];
                }
            }
        },
