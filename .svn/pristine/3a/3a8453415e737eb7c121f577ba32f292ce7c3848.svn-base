  ...
  <el-container>
    ...
    <el-container>
      <div class="content-new-fex"> 
        ...
        <history-page v-on:isAddNewBill_R='isAddNewBill_R' v-if="current==1" ></history-page>
      </div>
    </el-container>
  </el-container>
</el-container>
...
export default {
  ...
  methods: {
    ...
    clearSetItem(){
        this.$store.dispatch('cgdReturnDataList', {
            arr: [], obj:{}
        })
    },
    handleClose(done) {
  ...
  components: {
    addPage: () => import("@/views/goods/return/addNew.vue"),
    historyPage: () => import('@/views/goods/return/history.vue')
  }
};
</script>
<style scoped>
