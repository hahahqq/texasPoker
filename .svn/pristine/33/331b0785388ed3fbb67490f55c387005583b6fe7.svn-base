  ...
  <div class='history'>
                ...
                <el-form label-width="100px">
                  ...
                  <el-form-item label="店 铺 ：">
                    <el-select size='small' v-model="searchShopId" placeholder="请选择店铺">
                      <el-option v-for="item in shopList" :key="item.SHOPID" :label="item.SHOPNAME" :value="item.SHOPID" @change="outShop(item.SHOPID)"></el-option>
                    </el-select>
                  </el-form-item>
                </el-form>
              </div>
    ...
    <div class='history_content'>
      <el-table 
        ...
        <el-table-column label="差异" prop="GOODSQTY" align="center">
        </el-table-column>
    ...
    <el-dialog :title='`详情 (${title})`' :visible.sync="isShowDialog" width="80%" append-to-body>
      ...
      <el-table
        ...
        <el-table-column prop='MONEY' label="盈亏金额" align="center" fixed="right">
          <template slot-scope="scope">
            {{isPurViewFun(210040601) ? scope.row.MONEY : '****'}}
          </template>
        </el-table-column>
      </el-table>
