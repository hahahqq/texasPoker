<template>
  <!--列表-->
    <el-table border 
      ...
      <el-table-column prop="GOODSNAME" label="名称" width="160">
      </el-table-column>
      ...
      <el-table-column label="操作" width="170" fixed="right" align="right">
        <template slot-scope="scope">
          <el-button type="text" :disabled="scope.row.ISSTOP" size="small" @click="handleStop(scope.$index, scope.row)">停止</el-button>
