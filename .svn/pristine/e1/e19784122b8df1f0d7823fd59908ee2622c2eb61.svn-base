<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px" label-position="right">
            <el-row :gutter="10">
                <!-- <el-col :xs="24" :sm="24">
              ...
              v-model="ruleForm.Remark"
                ...
                <el-col :xs="24" :sm="24">
                    <el-form-item label="联系方式" class>
                        <el-input v-model.number="ruleForm.Tel" type="number" min="0" placeholder="请输入联系方式"></el-input>
                    </el-form-item>
