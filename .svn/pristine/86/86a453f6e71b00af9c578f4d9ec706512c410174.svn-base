                    ...
                    <div class="content-table4">
                        <div class="content-table-center">
                            ...
                            >
                                ...
                                <el-table-column prop="WRITETIME" label="活动时间" :formatter="formatDate">
                        ...
                        <el-dialog :title="dealType=='add'?'新增'+title:'编辑'+title" :visible.sync="dialogVisibles" width="55%">
                            <addPage @closeModal="dialogVisibles=false" @resetList="getNewData(1);dialogVisibles=false" :dealType="{type:dealType,state:dialogVisibles,itemData:itemData}"></addPage>
                        </el-dialog>
                </div>
            </el-container>
        </el-container>
