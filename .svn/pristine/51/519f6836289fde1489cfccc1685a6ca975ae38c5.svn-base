...
let selected={}
var ListARR = [
  { InterfaceCode:'21002071902',title:'销售分析明细',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
]
...
// actions
const actions = {
  getsaleReportData ({commit},data) { 
    let userInfo= getUserInfo();
    let homeInfo = getHomeData();
    let pn = parseInt(state.saleReportData.paying.PN) +1;
    let sendData = {
      'InterfaceCode': '21002071901',
