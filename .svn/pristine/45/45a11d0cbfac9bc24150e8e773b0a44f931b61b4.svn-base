    ...
    <div class="t-botton-timescountc" style="height: 100%;" ref="elememtt">
        ...
        <div class="f-botton-fs" style="height: 100%;">
            <el-row :gutter="24" style="height: 100%;">
                ...
                >   <div class="timescountc-top">计次消费</div>
                    ...
                    <div class="timescountc_left overflowscroll" ref="addsockheight">
                        ...
                        <ul id="addshopList">
                            <li class="danpintr">
                                <div class="danpintr-list">
                                    <el-row>
                                        <el-col :span="12">洗剪吹</el-col>
                                        <el-col :span="12">删除</el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :span="12">剩余次数12</el-col>
                                        <el-col :span="12">x2</el-col>
                                    </el-row>
                                </div>
                            </li>
                        </ul>
