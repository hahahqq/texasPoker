          ...
          <div class="content-new-fex">
            ...
            <div class="content-table4">
              <div class="content-table-center">
                ...
                <!--列表-->
                <el-table size='small' :data="tableData" v-loading="loading" max-height="500" header-row-class-name="bg-theme2 text-white " class="rull-width" >
  ...
  methods: {
    setPermission() {
      ...
      //   }
        ...
        this.$store.dispatch("setPermissionList", { uid: this.uid, parr:sendArr}).then(() => {
          this.loading = true;
        })
