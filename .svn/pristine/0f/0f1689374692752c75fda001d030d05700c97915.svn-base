      ...
      <div class="content-new-fex">
          <div class="content-eighty">
            <div class="content-center">
               <el-button size="small" type="primary" @click="handleDeal({})">添加支出项目</el-button>
            </div>
          </div>
                  ...
                  <el-table-column label="操作" align="right">
                    <template slot-scope="scope">
                      <el-button-group>
                        ...
                        >删除</el-button>
                        <el-button type="text" size="small" @click="handleDeal(scope.row)" style="margin-left:20px;">编辑</el-button>
                      </el-button-group>
