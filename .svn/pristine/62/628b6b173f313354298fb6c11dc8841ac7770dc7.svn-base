  ...
  <div>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
      <el-form-item label="支出项目" prop="ItemId">
        <el-select v-model="ruleForm.ItemId" placeholder="请选择支出项目" style="width:220px;">
      ...
      <el-form-item label="店铺" prop="ShopId">
        <el-select v-model="ruleForm.ShopId" placeholder="请选择店铺" style="width:220px;">
      ...
      <el-form-item label="支出日期" >
        <el-date-picker v-model="ruleForm.BillDate" type="date" value-format="timestamp" placeholder="选择日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="经手人" prop="EmpId">
        <el-select v-model="ruleForm.EmpId" placeholder="请选择经手人" style="width:220px;">
