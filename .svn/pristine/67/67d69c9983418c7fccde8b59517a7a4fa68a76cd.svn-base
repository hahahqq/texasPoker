...
// actions
const actions = {
  saveMttGame({commit}, data){  // MTT增加比赛
  ...
  mttCancelOrGameOver({commit}, data){   // MTT取消比赛  0 : 取消比赛  1：比赛结束
      let userInfo = getUserInfo()
      let sendData = {
  ...
  mttExitGame({commit}, data){  // MTT退出比赛
      let userInfo = getUserInfo()
      let sendData = {
  ...
  editMttGame({commit}, data){ // 修改mtt比赛
    let userInfo = getUserInfo()
  ...
  mttStartSignUp({commit}, data){  // mtt 比赛报名
    let userInfo = getUserInfo();
    let sendData = {
  ...
  mttSubmitReward({commit}, data){  // MTT领取奖励
    console.log(data)
    let userInfo = getUserInfo();
    let sendData = {
  ...
  mttCancelRewardVip({commit}, data){   // MTT取消奖励(按会员)
    let userInfo = getUserInfo()
    let sendData = {
