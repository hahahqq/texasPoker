        ...
        <!-- 支出明细 -->
          ...
          <div class="content-eighty">
              ...
              <el-row>
                ...
                <el-col :span="11">
                  <el-select v-model="pageData.ItemId" placeholder="请选择支出项目" clearable class="m-bottom-sm" size="small">
                    <el-option v-for="item in paymentList" :key="item.ID" :label="item.NAME" :value="item.ID"></el-option>
                  </el-select>
                  <el-select v-model="pageData.PayTypeId" placeholder="请选择付款方式" clearable class="m-bottom-sm" size="small">
                ...
                <el-col :span="11" style="text-align:right">
                  ...
                  ></el-date-picker>
                  <el-button type="primary" @click="getNewData(1)" class="m-bottom-sm" size="small">查 询</el-button>
                </el-col>
              </el-row>
              </div>
            </div>
                      ...
                      <el-table-column label="操作" fixed="right" align="right">
                        <template slot-scope="scope">
                          <el-button-group>
                            ...
                            <el-button type="text" size="small" @click="handleCancel(scope.$index, scope.row)" style="margin-left:20px;">删除</el-button>
                          </el-button-group>
