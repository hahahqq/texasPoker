<template>
  <div>
    ...
    <el-table size='small' :data="buyVipList" style="width: 100%; margin-top:10px" height='360' header-row-class-name="bg-F1F2F3">
    ...
    methods:{
      ...
      gameoverFun(){
        this.$confirm("确认结束当前比赛?", "提示", {
            ...
            this.$store.dispatch('integralCancelOrGameOver', { Type: 1, BillId: this.BillObj.BILLID }).then(() =>{
