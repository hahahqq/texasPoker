        ...
        <el-container>
            ...
            <el-container>
                <el-main :style="{height:height+'px'}">
                        ...
                        <div class="content-center">
                            <div class="m-bottom-sm">
                                <el-button
                                    ...
                                    icon="el-icon-plus"
                                >新增</el-button>
                                <el-button size="small" @click="getNewData">刷新</el-button>
                            </div>
                        </div>
                    </div>
                    <!--列表-->
                    <div class="content-table">
                        <div class="content-table-center">
                            <el-table
                                ...
                                style="width: 100%"
                            >
                                <el-table-column prop="NAME" label="积分比"></el-table-column>
                    ...
                    <el-dialog
                        :title="(this.dealType=='add'?'新增':'编辑')+'积分'"
    ...
    methods: {
        ...
        handleDel(index, item) {
            this.$confirm("此操作将永久删除, 是否继续?", "提示", {
                ...
                this.$store
                    .dispatch("delIntegralItem", { index: index, data: item })
                    .then(() => {
                        this.loading = true;
                        this.dealType = "del";
                    });
