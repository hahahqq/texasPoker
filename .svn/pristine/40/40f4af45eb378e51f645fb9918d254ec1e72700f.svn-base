...
import { 
  ...
  GET_ACHIEVEMENT_EXPORTDATA
} from '@/store/mutation-types'
let selected={}
var ListARR = [
  { InterfaceCode:'6010316_01_1',title:'业绩统计_详情',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
  { InterfaceCode:'6010316_0101',title:'业绩统计_售卡提成',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
  { InterfaceCode:'6010316_0102',title:'业绩统计_充值提成',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
  { InterfaceCode:'6010316_0103',title:'业绩统计_快速消费提成',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
  { InterfaceCode:'6010316_0104',title:'业绩统计_商品消费提成',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
  { InterfaceCode:'6010316_0105',title:'业绩统计_计次消费提成',paying:{ "TotalNumber": 0, "PageNumber": 0, "PageSize": 20, "PN": 0,  },List:[]  },
]
...
const state = {
  ...
  achievementReportData1:{},
  achievementReportList:[],
  achievementReportListState:{paying:{
    "TotalNumber": 0,
    "PageNumber": 0,
    "PageSize": 20,
    "PN": 0,
...
const getters = {
  ...
  achievementReportData1: state => state.achievementReportData1,
...
const actions = {
  ...
  getachievementReportData1 ({commit},data) {
    let userInfo= getUserInfo();
    let homeInfo = getHomeData();
    let sendData = {
      'InterfaceCode': '21002072321',
    ...
    commonSend.commonSend('get',data => {
      commit(GET_ACHIEVEMENT_EXPORTDATA, { data })
    }, sendData )
  },
...
const mutations = {
  ...
  [GET_ACHIEVEMENT_EXPORTDATA] (state, { data }) {
    if(data.success){
        state.achievementReportData1 = Object.assign({},data.data);
    }
    // state.achievementReportState1 = Object.assign({},data);
  },
  [GET_ACHIEVEMENT_LIST](state, { data }) {
    ...
    if(data.success){
      ...
      if(newArr.length>0){
        ...
        state.achievementReportListARR[selected.obj.index].List = [...state.achievementReportList]
      }
    }
    state.achievementReportListState = Object.assign({},data,{'paying':pageData,'List':state.achievementReportList});
    selected = {}
  },
