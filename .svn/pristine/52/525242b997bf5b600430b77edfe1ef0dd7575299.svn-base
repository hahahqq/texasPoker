    ...
    <el-form :inline="false" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px">
      <el-row :gutter="10">
        ...
        <el-col :span="6" style="padding-left: 20px">
          ...
          <div style="text-align: center; width: 140px; margin-top: 10px; color: #aaa">
            点击上传会员头像
          </div>
        </el-col>
      </el-row>
      ...
      <el-form-item>
        <el-button
          :disabled="memberLevelList.length == 0"
          type="primary"
          @click="submitForm"
          :loading="loading"
        >
...
export default {
  ...
  methods: {
    ...
    submitfun() {
      if (
        this.ruleForm.Passwd == null ||
        this.ruleForm.Passwd == "" ||
        this.ruleForm.Passwd == undefined
      ) {
        console.log("可以保存");
      } else {
      ...
      if (this.dealType.type == "edit") {
        ...
        (sendData.InvalidDate = this.ruleForm.InvalidDate), (sendData.id = this.itemInfo.ID);
        ...
        sendData.Passwd = this.ruleForm.Passwd
          ...
          : this.itemInfo.PASSWORD;
        methodName = "editTheMember";
      }

      sendData.BirthDate =
        this.ruleForm.BirthDate == "" ? "" : dayjs(this.ruleForm.BirthDate).format("YYYY-MM-DD");
