  ...
  <div class="shop-list">
    <div class="content-eighty">
      <div class="content-center">
        <div class="shop-bottom">
          <el-row>
            <el-col :span="18">
              <el-button size="small" type="primary" @click="handleDeal({})">添加员工</el-button>
            </el-col>
    ...
    <!--列表-->
        ...
        >
          ...
          <el-table-column prop="BIRTHDATE" label="出生日期" :formatter="formatbirthdate"></el-table-column>
    ...
    <!-- deal -->
    <el-dialog :title="dealType=='add'?'添加员工':'编辑员工'" :visible.sync="dialogVisible" width="600px">
      <editEmployeePage
