                        ...
                        <el-dialog title='新增限时特价' :visible.sync="showNewForm" append-to-body width="60%">
                            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px">
                                ...
                                <el-form-item label='会员折上折'>
                                    <el-tooltip class="item" effect="dark" content="启用之后，商品 会在优惠价的基础上继续执行会员折扣" placement="top-start">
                                        <el-button type="text" style='color:#999' icon='el-icon-question'></el-button>
                                    </el-tooltip>
                                    <el-switch v-model="ruleForm.IsVipDiscount" active-color="#fb789a" inactive-color="#cccccc"></el-switch>
                                </el-form-item>
                                <el-form-item label="是否启用">
                                    <span style='width:20px; height:10px; float:left'> </span>
                                    <el-switch v-model="ruleForm.IsStart" active-color="#fb789a" inactive-color="#cccccc"></el-switch>
                                </el-form-item>
